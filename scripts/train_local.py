#!/usr/bin/env python3
"""Train a lightweight YOLO detector for single-class signboard detection."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Train lightweight YOLO on curated signboard dataset.")
    ...
    parser.add_argument("--name", default="yolo26n_signboard_lite")
